...
**Το παρόν project αφορά τη δημιουργία εφαρμογής διαχείρισης e-shop προϊόντων τεχνολογίας και πληροφορικής**

* Μια σύντομη περιγραφή των απαιτήσεων της εφαρμογής βρίσκεται [ΕΔΩ](Requirements_description.md)